...
<head> 
    ...
    <style> 
    body {
        background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsMKLg1aZttqlf4Gs7mbP9-9G1pmki_2PM3Q&usqp=CAU
); 
    }
    body { 
    ...
    <div class="sidenav" id="mySidenav"> 
        ...
        <li> 
            <a href="<?php echo base_url('admin') ?>" <span class="ml-3"><i 
                    class="fa-thin fa-gauge">Sekolah</i></span> 
            </a> 
        </li> 
        <li> 
